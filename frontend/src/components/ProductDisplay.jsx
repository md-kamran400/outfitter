      ...
      <div className="flex flex-col gap-14 xl:flex-row">
        ...
        <div className="flex-col flex xl:flex-[1.5]">
          ...
          <div className="flex  gap-x-2 text-secondary medium-22">
            ...
            <MdStar />
            <MdStar />
            <p className="mt-0.5 text-slate-800">(111)</p>
          </div>
          <div className="flex gap-x-6 medium-22 my-4">
          ...
          <div className="mb-4">
            ...
            <p className="text-slate-900/80">
              <span className="medium-16 text-tertiary text-slate-900">
                Category :
              </span>
              Women | Jacket | Winter
            </p>
            <p className="text-slate-900/80">
              <span className="medium-16 text-tertiary text-slate-900/10">
                Tags :
              </span>
              Modern | Latest{" "}
            </p>
